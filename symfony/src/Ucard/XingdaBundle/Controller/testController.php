...
use Ucard\XingdaBundle\Entity\test;
use Ucard\XingdaBundle\Form\testType;
...
class testController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('UcardXingdaBundle:test')->findAll();
     ...
     * @Method("POST")
     * @Template("UcardXingdaBundle:test:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('UcardXingdaBundle:test')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("UcardXingdaBundle:test:edit.html.twig")
     */
