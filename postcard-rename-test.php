...
<body>
	...
	<p>Below are the postcard original country and destination country </p>
	Original Country: <select name="originalCountry">
	    <option value="">Country...</option>
	    <option value="Ireland">Ireland</option>
	    <option value="China">China</option>
	    <option value="United Kingdom">United Kingdom</option>
	</select> <br>
	Destination Country:<select name="destinationCountry">
	    <option value="">Country...</option>
	...
	<p> Assume the price is fixed and it is &euro;2.99</p>
