                ...
                <table width="99%" border="0" align="left"cellpadding="3" cellspacing="0" bgcolor="#ffffff" >
                    ...
                    <tr>
                        ...
                        <td width="83%" bgcolor="#FFFFFF">
                            <input name="manager_name" type="text" id="FName" value="<?php echo $manager[0]['name'] ?>" required>
                            <font color="red">*</font>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF">
                            <input name="manager_tel" type="text" id="FTel" value="<?php echo $manager[0]['tel'] ?>" required>
                            <font color="red">*</font>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF">
                            <input name="manager_address" type="text" id="FAddress" value="<?php echo $manager[0]['address'] ?>" size="40">
                            <font color="red">*</font>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF">
                            <input name="manager_postcode" type="text" id="FZip" value="<?php echo $manager[0]['postcode'] ?>">
                        </td>
                    </tr>
                    <tr>
                        <td height="26" align="right" bgcolor="#FFFFFF">E-mail：</td>
                        <td bgcolor="#FFFFFF">
                            <input name="manager_email" type="text" id="FEmail" value="<?php echo $manager[0]['email'] ?>" size="30" required>
                            <font color="red">*</font>
                        </td>
                    </tr>
                </table>
